...
typedef enum _GPSidePanelStyle
{
    GPSidePanelSingleActive = 0,
    GPSidePanelMultipleActive
} GPSidePanelStyle;

typedef enum _GPSidePanelState
{
    GPSidePanelCenterVisible = 1,
    GPSidePanelLeftVisible,
} GPSidePanelState;

@interface GPSidePanelController : UIViewController<UIGestureRecognizerDelegate>
...
// style
@property (nonatomic) GPSidePanelStyle style; // default is GPSidePanelSingleActive
...
@property (nonatomic, readonly) GPSidePanelState state;
